  ...
  return (
    <>
      ...
      <button
        ...
        className="lg:hidden fixed top-3 left-3 z-50 h-10 w-10 rounded-full bg-brand-dark text-white flex items-center justify-center shadow-lg border border-white/10"
      >
      ...
      <div
        className={cn(
          "w-64 h-screen bg-brand-dark text-slate-300 flex flex-col fixed left-0 top-0 z-50 overflow-y-auto border-r border-white/5 transition-transform duration-300 lg:translate-x-0",
      ...
      >
        <div className="p-6 flex items-start justify-between">
          ...
          <button
            ...
            className="lg:hidden h-9 w-9 -mr-2 flex items-center justify-center rounded-full text-slate-400 hover:bg-white/5 hover:text-white"
          >
            <X className="h-5 w-5" />
          </button>
        </div>
